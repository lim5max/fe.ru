      ...
      <div id="mobile-menu-items" class="fixed inset-0 bg-base-surface-1 z-50 hidden flex flex-col h-full">
        ...
        <div class="flex-1 overflow-auto p-4">
          ...
          <div class="flex flex-col gap-1">
            <h3 class="text-sm font-medium text-text-dark-secondary">Услуги</h3>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/globe.svg" alt="Домены" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Домены</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/hosting.svg" alt="Хостинг" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Хостинг</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/server.svg" alt="VPS/VDS" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">VPS/VDS</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/cloud-server.svg" alt="Серверы" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Серверы</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/more.svg" alt="Другие услуги" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Другие услуги</span>
            </a>
          </div>

          <!-- Additional Section -->
          <div class="flex flex-col gap-1 mt-4">
            <h3 class="text-sm font-medium text-text-dark-secondary">Дополнительно</h3>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/user-business.svg" alt="Партнерство" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Партнерство</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/customer-support.svg" alt="Поддержка" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Поддержка</span>
            </a>
          </div>

          <!-- Profile Section -->
          <div class="flex flex-col gap-1 mt-4">
            <h3 class="text-sm font-medium text-text-dark-secondary">Профиль</h3>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/user-02.svg" alt="Общая информация" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Общая информация</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/coins.svg" alt="Управление счетом" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Управление счетом</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/brochure.svg" alt="Документы и акты" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Документы и акты</span>
            </a>
            <a href="#" class="flex items-center gap-4 px-2 py-2.5 rounded-7 hover:bg-base-fill-1 transition-colors">
              <img src="../public/icons/settings-01.svg" alt="Настройки" class="w-6 h-6 opacity-70" />
              <span class="text-base-medium text-text-dark-secondary">Настройки</span>
            </a>
          </div>
        </div>
